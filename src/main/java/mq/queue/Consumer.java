            ...
            while (true) {
                ...
                if (message != null) {
                    if (message instanceof TextMessage) {
                        ...
                        TextMessage mes = session.createTextMessage("Message # is ok"+message.getJMSCorrelationID());
                        producer.send(mes);
                        System.out.println("send " + i++ + ". message: " + text+ ".---CorrelationID: " + message.getJMSCorrelationID());
                    }
                } else {
                    break;
                }
