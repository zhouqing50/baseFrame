...
public class TestDistributedLock {
    ...
    public static void main(String[] args) {
        ...
        final ZkClientExt zkClientExt1 = new ZkClientExt("192.168.34.92:2181", 5000, 5000, new BytesPushThroughSerializer());
        zkClientExt1.createPersistent("/Mutex");
        final SimpleDistributedLockMutex mutex1 = new SimpleDistributedLockMutex(zkClientExt1, "/Mutex");
        


        final ZkClientExt zkClientExt2 = new ZkClientExt("192.168.34.92:2181", 5000, 5000, new BytesPushThroughSerializer());
